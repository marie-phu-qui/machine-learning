...
// All of this can be specialy adapted to our own use

const TEXT_DATA_URLS = {
  'the Hobbit': {
    url: 'https://cdn.rawgit.com/marie-phu-qui/Lord-of-the-News/master/server/tensorflow/datasets/theHobbit.txt',
    needle: 'the Hobbit'
  },
  'the Fellowship of the ring': {
    url: 'https://cdn.rawgit.com/marie-phu-qui/Lord-of-the-News/master/server/tensorflow/datasets/theFellowshipOfTheRing.txt',
    needle: 'the Fellowship of the ring'
  },
  'the Return of the King': {
    url: 'https://cdn.rawgit.com/marie-phu-qui/Lord-of-the-News/master/server/tensorflow/datasets/theReturnoftheKing.txt',
    needle: 'the Return of the King'
  },
  'the Two Towers': {
    url: 'https://cdn.rawgit.com/marie-phu-qui/Lord-of-the-News/master/server/tensorflow/datasets/theTwoTowers.txt',
    needle: 'the Two Towers'
  }
}
